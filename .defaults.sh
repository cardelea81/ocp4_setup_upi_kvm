...
# --master-mem SIZE(MB)
export MAS_MEM="32000"

# --worker-cpu N(vCPU)
export WOR_CPU="24"

# --worker-mem SIZE(MB)
export WOR_MEM="75000"
...
export LB_IMG_URL="https://cloud.centos.org/centos/9-stream/x86_64/images/CentOS-Stream-GenericCloud-9-20240527.0.x86_64.qcow2"
